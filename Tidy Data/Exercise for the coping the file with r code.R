...
fullpath3 <- file.path(path , "Exercise for the coping the file with r code.R")
file.copy(fullpath3, "G:/Lesson/Ongoing/The A Shot/Da_Wa/Data-Wrangling/Data import")
